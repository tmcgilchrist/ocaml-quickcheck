...
(* OASIS_START *)
(* DO NOT EDIT (digest: 01708502d6b61f2fe521713b63e5e814) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["QuickCheck"; "QuickCheck_gen"; "QuickCheck_util"];
                      lib_pack = false;
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests/";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "quickcheck"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/camlunity/ocaml-quickcheck.git";
                      src_repo_browser =
                        Some "https://github.com/camlunity/ocaml-quickcheck";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\024|à\133\007R:­\130÷\157\007\007¿\132\019";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
